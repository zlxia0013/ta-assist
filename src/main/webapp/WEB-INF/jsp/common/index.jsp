    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="active" id="menuFundBaseInfo"><a href="#"><i class="fa fa-link"></i> <span>基金管理</span></a></li>
                <li><a href="#" id="menuDistributor"><i class="fa fa-link"></i> <span>销售商管理</span></a></li>
                <li><a href="#" id="menuUser"><i class="fa fa-link"></i> <span>用户管理</span></a></li>
                <li class="treeview">
